...
%update_sedimets function convert BC values for sediment module (different Units)
    ...
    sediment_bc.H3O_c = 10.^-7.4*10^3; % 10.^-mylake_temp_results.pHz(end)*10^3;
    ...
    sediment_bc.CH4g_c = 0; % dissolved_bc_with_effective_depth(mylake_temp_results.CH4gz, sediment_params, mylake_params, effective_depth);
    ...
    sediment_bc.PO4adsc_fx = 0; % dissolved_bc_with_effective_depth(mylake_temp_results.CH4gz, sediment_params, mylake_params, effective_depth);
